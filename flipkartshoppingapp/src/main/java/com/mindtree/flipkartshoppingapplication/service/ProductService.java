...
public interface ProductService {
	...
	List<ProductDto> getProductByBrand(int brandId) throws FlipkartShoppingApplicationException;
     List<ProductDto> getShirtsByBrand(int brandId) throws FlipkartShoppingApplicationException;

  List<ProductDto> getJacketsByBrand(int brandId) throws FlipkartShoppingApplicationException;
