...
<title  class="text-primary">Add Vechiles</title>
...
<body>
  <h1 style="text-align:center;"  class="text-primary">Add Vechiles</h1>
  <hr>
  <div class="container">
    <form action="/addVechiles" method="post">
     ...
     <h3> <label for="userId"  class="text-primary">User:</label></h3>
      ...
      <br><br>
     <div class="form-group">
        <h3><label for="vechileName"  class="text-primary">Vechile Name:</label></h3>
          <input type ="text" id="vechileName" name="vechileName" class="form-control" >
        </div>
        <div class="form-group">
        <h3><label for="vechileState"  class="text-primary">Vechile State:</label></h3>
          <input type ="text" id="vechileState" name="vechileState" class="form-control" >
        </div>
       
      <div class="form-group">
        <h3><label for="vechileCountry"  class="text-primary">Vechile Country:</label></h3>
