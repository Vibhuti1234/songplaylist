...
<style>
body{
 background: url(https://latestwallpapershd.com/wp-content/uploads/2018/12/Beautiful-cars-wallpaper-HD.jpg);
...
<title >Vechile Registration Application</title>
...
<body >
  <h1 style="text-align:center;">Vechile Registration Application</h1>
  <hr>
  <div class="container">
    <form action="/addUser" > 
